...
<main class="bg-gray-100 flex-1 p-6 overflow-auto">
    <div class="flex flex-col">
        <!-- Judul Halaman -->
        <h1 class="text-2xl font-bold text-gray-900 mb-5">Tambah</h1>
    ...
    <div class="mb-2 border-solid border-gray- rounded border shadow-sm w-full">
        ...
        <form action="{{ route('merk.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-4 px-6 py-4">
                <label for="nama_jenis" class="block text-sm font-medium text-gray-700 mb-2">Nama Merk</label>
                <input type="text" name="nama_merk" class="w-full px-6 py-2 border border-gray-300 rounded focus:outline-none focus:ring focus:border-blue-500">
            </div>
