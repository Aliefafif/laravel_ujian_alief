    ...
    <div class="mb-2 border-solid border-gray- rounded border shadow-sm w-full">
        ...
        <form action="{{ route('jenis.update',$jenis->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <label for="nama">Nama</label>
                            <input type="text" class="w-full px-6 py-2 border border-gray-300 rounded focus:outline-none focus:ring focus:border-blue-500" name="nama_jenis" value="{{$jenis->nama_jenis}}">
                        </div>
